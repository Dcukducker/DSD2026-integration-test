...
# Configurable via V2_BASE_URL env var (default: localhost for integration test)
DEFAULT_BASE_URL = os.environ.get("V2_BASE_URL", "http://localhost:3000") + "/measurements"
